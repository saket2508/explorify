    ...
    return(
        ...
        <div className="dark:bg-primary-dark bg-primary-light flex-1 overflow-y-scroll">
              ...
              <img src="/images/tracks_bg.jpg" className="h-64 sm:h-80 w-full object-cover"/>
                    ...
                    <div className="absolute lg:hidden top-0 right-0 h-6 w-6 m-4 flex items-center justify-center rounded-full shadow-lg cursor-pointer bg-white text-black">
                      <button className="focus:outline-none" onClick={() => setTheme(colorTheme)}>
                      {colorTheme==='light' ? <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="inline-flex items-center gap-6">
                   ...
                   {item.album.images && <img src={item.album.images[0].url} className="h-16 w-16 rounded-md object-cover">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-xs md:text-sm font-semibold dark:text-text-secondary-dark text-text-secondary-light">
