      ...
      <div className="dark:bg-primary-dark bg-primary-light flex-1 overflow-y-scroll">
        <div className="relative dark:bg-primary-dark bg-primary-light">
          <img
            ...
            src="https://images.unsplash.com/photo-1524678606370-a47ad25cb82a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
          />
                  ...
                  <div className="py-4 px-5 hover:bg-card-light dark:hover:bg-card-dark">
                    <div className="grid grid-flow-col w-full justify-start items-center gap-6">
                      ...
                      <div className="flex flex-col">
                        <div className="text-sm md:text-base font-semibold pb-1 dark:text-text-primary-dark text-text-primary-light">
                          {item.track.name}
                        </div>
