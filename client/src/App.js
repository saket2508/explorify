...
function App() {
  return (
    <div className="App">
      ...
      <Router>
        <main className="w-64 bg-white">
          <div className="text-yellow-400 pt-10 md:px-4 lg:px-6 font-bold text-2xl tracking-wider">
            Explorify
          </div>
          <div className="pt-20 md:px-4 lg:px-6">
            <nav className="flex flex-col gap-6">
              <Link to="/">
                <div className="font-semibold text-lg py-3 flex text-gray-700 items-center">
                  <span className="pr-2">
              ...
              <Link to="/top-tracks">
                <div className="font-semibold text-lg py-3 flex text-gray-400 hover:text-gray-700 items-center">
                  <span className="pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="lg:hidden min-h-screen flex flex-col">
        ...
        <div className="flex-0 sticky overflow-hidden bottom-0 left-0 right-0">
          <div className="py-5 px-10 bg-white text-gray-700 shadow-lg w-full flex justify-around">
            <Link to="/">
